...
// Sample blog data related to BlinkFit
const sampleBlogs = [
  {
  ...
  },
  {
    ...
    <p>Traditional eye care often focuses on reactive treatment – addressing problems after they occur. AI technology enables a proactive approach by continuously monitoring eye health and detecting issues before they become serious problems.</p>
  ...
  },
  {
    ...
    featuredImage: "https://images.unsplash.com/photo-1586985289688-ca3cf47d3e6e?w=600&h=400&fit=crop",
    readTime: 6,
    published: true,
    views: 743,
    likes: 67,
  ...
  },
  {
    ...
    featuredImage: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=600&h=400&fit=crop",
    readTime: 6,
    published: true,
    views: 2104,
    likes: 298,
...
const seedDatabase = async () => {
  try {
    ...
    console.log(`✅ Successfully seeded ${sampleBlogs.length} blog posts`);
